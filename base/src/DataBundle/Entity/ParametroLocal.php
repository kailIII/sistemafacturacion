...
class ParametroLocal
{
    ...
    /**
     * @var \DataBundle\Entity\Parametro
     */
    private $par;
     ...
     * Set par
     *
     * @param \DataBundle\Entity\Parametro $par
     *
     * @return ParametroLocal
     */
    public function setPar(\DataBundle\Entity\Parametro $par = null)
    {
        $this->par = $par;
     ...
     * Get par
     *
     * @return \DataBundle\Entity\Parametro
     */
