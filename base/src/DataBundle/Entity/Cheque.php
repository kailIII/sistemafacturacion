...
class Cheque
{
    ...
    /**
     * @var \DataBundle\Entity\Cuenta
     */
    private $cue;

    /**
     * @var \DataBundle\Entity\TipoCheque
     */
    private $tipche;
     ...
     * Set cue
     *
     * @param \DataBundle\Entity\Cuenta $cue
     *
     * @return Cheque
     */
    public function setCue(\DataBundle\Entity\Cuenta $cue = null)
    {
        $this->cue = $cue;
     ...
     * Get cue
     *
     * @return \DataBundle\Entity\Cuenta
     */
     ...
     * Set tipche
     *
     * @param \DataBundle\Entity\TipoCheque $tipche
     *
     * @return Cheque
     */
    public function setTipche(\DataBundle\Entity\TipoCheque $tipche = null)
    {
        $this->tipche = $tipche;
     ...
     * Get tipche
     *
     * @return \DataBundle\Entity\TipoCheque
     */
