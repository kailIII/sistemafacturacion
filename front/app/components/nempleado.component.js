...
var NempleadoComponent = (function () {
    function NempleadoComponent() {
        this.titulo = "Componente Nuevo Empleado";
        // OnVerDetalleSol(){
    ...
    // 	){
    // }
    NempleadoComponent.prototype.ngOnInit = function () {
        // this.menuUsuario();
    ...
    return NempleadoComponent;
}());
NempleadoComponent = __decorate([
    core_1.Component({
        selector: "nempleado",
        templateUrl: "app/view/nempleado.html" /*,
        providers: [LoginService, SolicitudService]*/
    })
], NempleadoComponent);
exports.NempleadoComponent = NempleadoComponent;
//# sourceMappingURL=nempleado.component.js.map