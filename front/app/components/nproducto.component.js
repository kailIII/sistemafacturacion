...
var NproductoComponent = (function () {
    function NproductoComponent() {
        this.titulo = "Componente Nuevo producto";
        // OnVerDetalleSol(){
    ...
    // 	){
    // }
    NproductoComponent.prototype.ngOnInit = function () {
        // this.menuUsuario();
    ...
    return NproductoComponent;
}());
NproductoComponent = __decorate([
    core_1.Component({
        selector: "nproducto",
        templateUrl: "app/view/nproducto.html" /*,
        providers: [LoginService, SolicitudService]*/
    })
], NproductoComponent);
exports.NproductoComponent = NproductoComponent;
//# sourceMappingURL=nproducto.component.js.map