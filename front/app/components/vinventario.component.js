...
var VinventarioComponent = (function () {
    function VinventarioComponent() {
        this.titulo = "Componente Inventario";
        // OnVerDetalleSol(){
    ...
    // 	){
    // }
    VinventarioComponent.prototype.ngOnInit = function () {
        // this.menuUsuario();
    ...
    return VinventarioComponent;
}());
VinventarioComponent = __decorate([
    core_1.Component({
        selector: "vinventario",
        templateUrl: "app/view/vinventario.html" /*,
        providers: [LoginService, SolicitudService]*/
    })
], VinventarioComponent);
exports.VinventarioComponent = VinventarioComponent;
//# sourceMappingURL=vinventario.component.js.map