...
var NventaComponent = (function () {
    function NventaComponent() {
        this.titulo = "Componente Nueva venta";
        // OnVerDetalleSol(){
    ...
    // 	){
    // }
    NventaComponent.prototype.ngOnInit = function () {
        // this.menuUsuario();
    ...
    return NventaComponent;
}());
NventaComponent = __decorate([
    core_1.Component({
        selector: "nventa",
        templateUrl: "app/view/nventa.html" /*,
        providers: [LoginService, SolicitudService]*/
    })
], NventaComponent);
exports.NventaComponent = NventaComponent;
//# sourceMappingURL=nventa.component.js.map