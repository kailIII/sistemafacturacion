...
var NcompraComponent = (function () {
    function NcompraComponent() {
        this.titulo = "Componente Nueva compra";
        // OnVerDetalleSol(){
    ...
    // 	){
    // }
    NcompraComponent.prototype.ngOnInit = function () {
        // this.menuUsuario();
    ...
    return NcompraComponent;
}());
NcompraComponent = __decorate([
    core_1.Component({
        selector: "ncompra",
        templateUrl: "app/view/ncompra.html" /*,
        providers: [LoginService, SolicitudService]*/
    })
], NcompraComponent);
exports.NcompraComponent = NcompraComponent;
//# sourceMappingURL=ncompra.component.js.map