...
var NproveedorComponent = (function () {
    function NproveedorComponent() {
        this.titulo = "Componente Nuevo proveedor";
        // OnVerDetalleSol(){
    ...
    // 	){
    // }
    NproveedorComponent.prototype.ngOnInit = function () {
        // this.menuUsuario();
    ...
    return NproveedorComponent;
}());
NproveedorComponent = __decorate([
    core_1.Component({
        selector: "nproveedor",
        templateUrl: "app/view/nproveedor.html" /*,
        providers: [LoginService, SolicitudService]*/
    })
], NproveedorComponent);
exports.NproveedorComponent = NproveedorComponent;
//# sourceMappingURL=nproveedor.component.js.map