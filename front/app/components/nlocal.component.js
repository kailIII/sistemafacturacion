...
var NlocalComponent = (function () {
    function NlocalComponent() {
        this.titulo = "Componente Nuevo Local";
        // OnVerDetalleSol(){
    ...
    // 	){
    // }
    NlocalComponent.prototype.ngOnInit = function () {
        // this.menuUsuario();
    ...
    return NlocalComponent;
}());
NlocalComponent = __decorate([
    core_1.Component({
        selector: "nlocal",
        templateUrl: "app/view/nlocal.html" /*,
        providers: [LoginService, SolicitudService]*/
    })
], NlocalComponent);
exports.NlocalComponent = NlocalComponent;
//# sourceMappingURL=nlocal.component.js.map