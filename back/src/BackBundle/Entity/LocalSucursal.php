...
class LocalSucursal
{
    ...
    /**
     * @var \BackBundle\Entity\Almacen
     */
    private $alm;

    /**
     * @var \BackBundle\Entity\Georeferencia
     */
    private $geo;

    /**
     * @var \BackBundle\Entity\ParametroLocal
     */
    private $parloc;
     ...
     * Set alm
     *
     * @param \BackBundle\Entity\Almacen $alm
     *
     * @return LocalSucursal
     */
    public function setAlm(\BackBundle\Entity\Almacen $alm = null)
    {
        $this->alm = $alm;
     ...
     * Get alm
     *
     * @return \BackBundle\Entity\Almacen
     */
     ...
     * Set geo
     *
     * @param \BackBundle\Entity\Georeferencia $geo
     *
     * @return LocalSucursal
     */
    public function setGeo(\BackBundle\Entity\Georeferencia $geo = null)
    {
        $this->geo = $geo;
     ...
     * Get geo
     *
     * @return \BackBundle\Entity\Georeferencia
     */
     ...
     * Set parloc
     *
     * @param \BackBundle\Entity\ParametroLocal $parloc
     *
     * @return LocalSucursal
     */
    public function setParloc(\BackBundle\Entity\ParametroLocal $parloc = null)
    {
        $this->parloc = $parloc;
     ...
     * Get parloc
     *
     * @return \BackBundle\Entity\ParametroLocal
     */
